      ...
      <DialogContent className="flex flex-col gap-4 sm:max-w-[600px]">
        ...
        <div>
          <div className="flex flex-col gap-1 text-sm">
            ...
            <Link target="_blank" rel="noopener noreferrer" className="flex gap-2" href={`https://peakd.com${path}`}>
              {'•'}
              <span className="text-destructive">https://peakd.com</span>
              <Icons.forward />
            </Link>
            <Link target="_blank" rel="noopener noreferrer" href={`https://ecency.com${path}`} className="flex gap-2">
              {'•'}
              <span className="text-destructive">https://ecency.com</span>
              <Icons.forward />
            </Link>
            <Link target="_blank" rel="noopener noreferrer" href={`https://waivio.com${path}`} className="flex gap-2">
        ...
        <div>
          <div className="flex flex-col gap-1 text-sm">
            ...
            <Link target="_blank" rel="noopener noreferrer" className="flex gap-2" href={`https://hiveblocks.com${path}`}>
              {'•'} <span className="text-destructive">https://hiveblocks.com </span>
              <Icons.forward />
            </Link>
            <Link target="_blank" rel="noopener noreferrer" href={`https://hive.ausbit.dev${path}`} className="flex gap-2">
              {'•'} <span className="text-destructive">https://hive.ausbit.dev </span>
              <Icons.forward />
            </Link>
            <Link target="_blank" rel="noopener noreferrer" href={`https://hiveblockexplorer.com${path}`} className="flex gap-2">
