...
const TAB_TITLE = 'Privacy Policy - Hive';
function Privacy() {
  return (
    <>
      <Head>
          ...
          <div>
            ...
            <p className="mb-4 ">
              <span>
                ...
                you use our Site (we refer to this information as &ldquo;Log Data&ldquo;). Log Data may
                include information such as a user&rsquo;s Internet Protocol (IP) address, device and browser
                type, and operating system. We use this information to administer and provide access to the
                Services
              </span>
            </p>
            <p className="mb-4 ">
            ...
            <p className="mb-4 ">
              <span>
                Business Transfers. We may share personal information when we do a business deal, or negotiate
                a business deal, involving the sale or transfer of all or a part of our business or assets.
            ...
            <p className="mb-4 ">
              <span>
                ...
                United States and in other countries. Your personal information may be transferred to or from
                the United States or other locations outside of your state, province, country or other
            ...
            <p className="mb-4 ">
              <span>
                ...
                other form of authentication involved in obtaining access to password protected or secure
            ...
            <p className="mb-4 ">
              <span>
                ...
                of posting). In all cases, your continued use of the the Site or Services after the posting of
            ...
            <p className="mb-4 ">
              <span>
                ...
                Consistent with the requirements of the Children&#39;s Online Privacy Protection Act (COPPA),
                if we learn that we have received any information directly from a child under age 13 without
                first receiving his or her parent&#39;s verified consent, we will use that information only to
                respond directly to that child (or his or her parent or legal guardian) to inform the child
                that he or she cannot use the Site and subsequently we will delete that information.
              </span>
            </p>
            <p className="mb-4 ">
              <span />
            ...
            <p className="mb-4 ">
              <span>
                ...
                table below. If you have questions about the legal bases under which we process your personal
            ...
            <p className="mb-4 ">
              <span>
                ...
                we are permitted by law to do so and where the reason is compatible with the purpose for which
                we collected it. If we need to use your personal information for an unrelated purpose, we will
            ...
            <p className="mb-4 ">
              <span>
                ...
                or permit us to decline your request. If we decline your request, we will tell you why,
                subject to legal restrictions. If you would like to submit a complaint about our use of your
                personal information or response to your requests regarding your personal information, you may
                contact us at privacy@hive.io or submit a complaint to the data protection regulator in your
                jurisdiction.
              </span>
              <span>.</span>
            </p>
            ...
            <p className="mb-4 ">
              <span>
                ...
                us recognize that you have created an account and have logged into that account to access Site
            ...
            <p className="mb-4 ">
              <span>
                ...
                results. Cookies are either &ldquo;session&rdquo; Cookies which are deleted when you end your
                browser session, or &ldquo;persistent,&rdquo; which remain until their deletion by you
                (discussed below) or the party who served the cookie. &nbsp;Full details on all of the Cookies
                used on the Site are available at our Cookie Disclosure table below.
              </span>
            </p>
            <p className="mb-4 ">
              <span />
