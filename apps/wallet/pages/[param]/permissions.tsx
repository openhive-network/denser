...
function Permissions({ username, metadata }: InferGetServerSidePropsType<typeof getServerSideProps>) {
      ...
      <ProfileLayout>
        <div className="flex flex-col gap-8 ">
          ...
          <div className="flex flex-col gap-8 px-6">
            ...
            <Card
              className={cn('flex flex-col text-sm drop-shadow-xl dark:bg-background/95 dark:text-white')}
            >
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  return {
    props: {
      metadata: await getAccountMetadata(username, 'Permissions'),
