...
function VoteProposals({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2/3 h-5/6 overflow-auto px-3 pt-3 gap-3" data-testid="vote-proposals-dialog">
        <div className="border-b-2 border-solid border-slate-600 pb-2 h-fit">
          Votes on proposal <span className="text-red-500" data-testid="proposal-id-dialog">#{id}</span>
        </div>
        <VotersList
          id={id}
