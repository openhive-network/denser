...
export function ProposalListItem({ proposalData, totalShares, totalVestingFund }: ListItemProps) {
  ...
  return (
    <div className="flex flex-col justify-between bg-white p-2.5 drop-shadow-xl dark:bg-slate-800 sm:flex-row " data-testid="proposal-item">
      <div className="w-3/4" data-testid="proposal-item-content">
        <Link href={link}>
          <span className="font-medium text-red-600 hover:text-red-300 dark:text-blue-500 dark:hover:text-blue-400 md:text-xl">
            ...
            <span className="font-semibold text-slate-500" data-testid="proposal-item-id">
              {' #'}
              {proposalData.proposal_id}
            </span>
          </span>
        </Link>
        <div className="flex flex w-fit flex-col gap-3 py-3 text-xs md:text-sm min-[900px]:flex-row lg:items-center" data-testid="proposal-item-row-description">
        ...
        <div className="flex items-center gap-1 text-xs md:text-sm" data-testid="proposal-item-details">
      ...
      <div className="mt-3 flex justify-between border-t-2 border-slate-300 p-2  dark:border-slate-600 sm:ml-2 sm:w-32 sm:w-32 sm:flex-col sm:items-center sm:border-l-2 sm:border-t-0 sm:pl-4" data-testid="proposal-item-vote">
