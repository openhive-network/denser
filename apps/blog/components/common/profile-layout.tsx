            ...
            <div className='mt-4 flex items-center'>
              ...
              {profileData.name ? (
                ...
                >
                  <img
                    alt='fish image'
                    title={t('cards.user_profil.hive_buzz_badge_title', { value: profileData.name })}
              ...
              {twitterData ? (
                <Link
                  ...
                  title={t('cards.user_profil.twitter_badge_title')}
                  target='_blank'
                >
              ...
              <li className='flex items-center gap-1'>
                ...
                >
                  {profileData?.follow_stats?.follower_count === 0 || undefined
                    ? t('cards.user_profil.lists.follower_count.zero')
                    : profileData?.follow_stats?.follower_count === 1
                      ? t('cards.user_profil.lists.follower_count.one') :
                      t('cards.user_profil.lists.follower_count.other', { value: profileData?.follow_stats?.follower_count })}
                </Link>
              </li>
              ...
              gap-1'>
                ...
                >
                  {profileData?.post_count === 0
                    ? t('cards.user_profil.lists.post_count.zero')
                    : profileData?.post_count === 1
                      ? t('cards.user_profil.lists.post_count.one')
                      : t('cards.user_profil.lists.post_count.other', { value: profileData?.post_count })}
                </Link>
              </li>
              ...
              gap-1'>
                ...
                >
                  {profileData?.follow_stats?.following_count === 0 || undefined
                    ? t('cards.user_profil.lists.followed_count.zero')
                    : profileData?.follow_stats?.following_count === 1 ? t('cards.user_profil.lists.followed_count.one') : t('cards.user_profil.lists.followed_count.other', { value: profileData?.follow_stats?.following_count })}
                </Link>
              </li>
            ...
            <ul className='my-1 flex flex-wrap justify-center gap-2 text-xs sm:text-sm'>
              <li className='flex items-center gap-1'>
                <Link
                  ...
                  className='hover:cursor-pointer hover:text-red-600 hover:underline'
                >
                  {t('cards.user_profil.lists.blacklisted_users')}
                </Link>
              </li>
              ...
              <li className='flex items-center gap-1'>
                ...
                <Link
                  ...
                  className='hover:cursor-pointer hover:text-red-600 hover:underline'
                >
                  {t('cards.user_profil.lists.muted_users')}
                </Link>
              </li>
