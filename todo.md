...
- [x] a) Change favicon to logo in env
- [x] b) Certain modals still have red, need to change that to env color
- [x] c) delegation total needs to be shown under the staked pimp
