...
DIND_TAG=${DIND_TAG:-"denser-5"}
COMPOSE_TAG=${COMPOSE_TAG:-"denser-5"}
...
OPTIONS:
  ...
  --dind-tag=TAG                            Tag of registry.gitlab.syncad.com/hive/haf_api_node/dind to use (default: denser-5)
  --compose-tag=TAG                         Tag of registry.gitlab.syncad.com/hive/haf_api_node/compose to use (default: denser-5)
  ...
  --api-version=VERSION                     API version (default: 1.27.6rc9)
  --haf-version=TAG                         HAF tag to use (default: 1.27.6rc9)
  --hivemind-version=TAG                    Hivemind tag to use (default: 1.27.6rc9)
  --hafah-version=TAG                       HAfAH tag to use (default: 1.27.6rc9)
