...
export const corsOptionsDefault: CorsOptions = {
  ...
  maxAge:
    (process.env.DENSER_SERVER_API_CORS_MAX_AGE && parseInt(process.env.DENSER_SERVER_API_CORS_MAX_AGE)) ||
    undefined,
  preflightContinue: false,
  optionsSuccessStatus:
    (process.env.DENSER_SERVER_API_CORS_OPTIONS_SUCCESS_STATUS &&
      parseInt(process.env.DENSER_SERVER_API_CORS_OPTIONS_SUCCESS_STATUS)) ||
    204
};
