...
import { IWitness, getWitnessesByVote } from '@/blog/lib/wallet/hive';
import WitnessListItem from '@/blog/components/wallet/witnesses-list-item';
import DialogLogin from '@/blog/components/wallet/dialog-login';
import { GetServerSideProps } from 'next';
import { useTranslation } from 'next-i18next';
import { useUser } from '@smart-signer/lib/auth/use-user';
import { getServerSidePropsDefault } from '@/blog/lib/wallet/get-translations';
import { useWitnessVoteMutation } from '@/blog/components/wallet/hooks/use-vote-witness-mutation';
import WitnessRemoveVote from '@/blog/components/wallet/witness-remove-vote';
import { CircleSpinner } from 'react-spinners-kit';
import { useSetProxyMutation } from '@/blog/components/wallet/hooks/use-set-proxy-mutation';
import {
  Dialog,
  DialogContent,
  DialogDescription,
          ...
          <table className="mt-4 w-full table-auto">
            ...
            >
              <tr className="font-semibold sm:text-sm">
                ...
                <th className="p-2">{t('witnesses_page.version')}</th>
                <th className="p-2">{t('witnesses_page.votes_received')}</th>
                <th className="p-2">{t('witnesses_page.last_block')}</th>
            ...
            <tbody data-testid="witness-table-body">
              {witnessesLoading || dynamicLoading || accountLoading ? (
                <tr>
                  <td className="animate-pulse p-2 text-xs">{t('global.loading')}</td>
                  <td className="animate-pulse p-2 text-xs">...</td>
                  <td className="animate-pulse p-2 text-xs">...</td>
                  <td className="animate-pulse p-2 text-xs">...</td>
                </tr>
