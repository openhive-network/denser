    ...
    <>
      <div
        ...
        className={cn(
          ...
          'prose-table:verflow-x-auto prose max-w-full prose-a:whitespace-pre-wrap prose-a:break-words prose-a:no-underline prose-blockquote:-indent-[3px] prose-code:break-words prose-code:-indent-[3px] prose-code:leading-[19px] prose-pre:-indent-[3px] prose-table:border-collapse prose-table:border prose-td:border prose-td:align-middle prose-img:cursor-pointer' // general
        )}
