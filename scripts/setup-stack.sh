...
DIND_TAG=${DIND_TAG:-"denser-6"}
COMPOSE_TAG=${COMPOSE_TAG:-"denser-6"}
...
OPTIONS:
  ...
  --dind-tag=TAG                            Tag of registry.gitlab.syncad.com/hive/haf_api_node/dind to use (default: denser-6)
  --compose-tag=TAG                         Tag of registry.gitlab.syncad.com/hive/haf_api_node/compose to use (default: denser-6)
