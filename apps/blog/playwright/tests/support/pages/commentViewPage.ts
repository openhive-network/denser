...
export class CommentViewPage{
    ...
    readonly getHoverCardContent: Locator;
    ...
    constructor(page:Page){
        ...
        this.getMainCommentUpvoteButton = this.getMainCommentFooterAuthorData.locator('[data-testid="upvote-button"]');
        this.getMainCommentDownvoteButton = this.getMainCommentFooterAuthorData.locator('[data-testid="downvote-button"]');
        ...
        this.getHoverCardContent = page.locator('[data-testid="user-hover-card-content"]');

        this.getResponseCommentHeader = page.locator('[data-testid="comment-card-header"]');
        this.getResponseCommentAuthorNameLink = this.getResponseCommentHeader.locator('[data-testid="author-name-link"]');
        this.getResponseCommentAuthorReputation = this.getResponseCommentHeader.locator('[data-testid="author-reputation"]');
        this.getResponseCommentAffiliationTag =  this.getResponseCommentHeader.locator('[data-testid="comment-user-affiliation-tag"]');
        this.getResponseCommentTimestamp = this.getResponseCommentHeader.locator('[data-testid="comment-timestamp-link"]');
        this.getResponseCommentPageLink = this.getResponseCommentHeader.locator('[data-testid="comment-page-link"]');
        ...
        this.getResponseCommentUpvoteButton = this.getResponseCommentFooter.locator('[data-testid="comment-card-footer-upvote"]');
        this.getResponseCommentDownvoteButton = this.getResponseCommentFooter.locator('[data-testid="comment-card-footer-downvote"]');
